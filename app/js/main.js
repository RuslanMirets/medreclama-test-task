...
/* harmony import */ var _components_sortable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/sortable */ "./src/js/components/sortable.js");
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".specialists__content", {
  grabCursor: true,
  slidesPerView: 2,
  spaceBetween: 10,
  navigation: {
...
sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(sortable, {
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".promo__form", rules);
...
const validateForms = (selector, rules) => {
  ...
  const textSelector = form === null || form === void 0 ? void 0 : form.querySelector('input[type="text"]');
